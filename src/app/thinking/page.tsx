      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {thoughts.map((thought, idx) => (
            ...
            >
              <Card gradient className="h-full flex flex-col relative overflow-hidden group">
                <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:opacity-20 transition-opacity transform group-hover:scale-110 duration-500">
                  {thought.icon}
                </div>
                
                <span className="text-xs tracking-widest uppercase text-blue-400 mb-4 font-mono">
                  &lt; {thought.theme} /&gt;
                </span>
                <h3 className="text-2xl font-bold mb-4 z-10">{thought.title}</h3>
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-light text-white italic max-w-3xl mx-auto leading-relaxed">
