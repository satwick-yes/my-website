            ...
            <div className="p-6 md:p-12 overflow-y-auto space-y-16 text-gray-300 leading-relaxed scroll-smooth" style={{ scrollbarWidth: 'thin', scrollbarColor: '#d48b37 #111' }}>
              ...
              <section className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                  {[...Array(10)].map((_, i) => (
                    <div key={i + 1} className="group relative overflow-hidden rounded-lg border border-white/10 bg-black/40 hover:border-primary/50 transition-colors shadow-lg">
